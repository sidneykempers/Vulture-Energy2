...
<div class="column">
      <div class="card">
      <img src="images/<?php echo $row[5];?>.jpg" alt="Jane" style="width: 100%;" height="320vh">
        <div class="container">
        <br>
...
<?php
 ...
 ?>
  ...
  <?php
        $sql = "SELECT * FROM aanbiedingen WHERE begindatum < NOW() AND einddatum > NOW() OR begindatum > NOW()
        ORDER BY begindatum ASC LIMIT 0,3" ;
        if($result = $conn->query($sql)) {
            while($row = $result->fetch_row()) {
